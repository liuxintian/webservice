...
<body class="nav-md">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <button type="button" class="btn btn-default" data-toggle="modal" data-target=".add-new-user-admin"> <i class="fa fa-plus"></i> Add New User</button>
            ...
            <div class="loading-sec hidden"></div>
             <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="clearfix">
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input disabled="disabled" data-api-attr="loginName" type="text" id="login-name2" maxlength="100" data-parsley-type="email" data-parsley-required="true" value="" placeholder="ex. johnDoe"  class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>
                            <div class="form-group">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input data-api-attr="password" type="text" id="password2" maxlength="80" value="" placeholder="john Doe" data-parsley-required="true" class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>

                            <div class="form-group">
                                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="notes2">User Contact <span class="required">*</span>
                                 </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input data-api-attr="notes" type="text" id="notes2" maxlength="80" value="" placeholder="user contact" data-parsley-required="true" class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>
                ...
                <div id="sucess-model-update" class="text-center hidden ">
                    <h4 class="mtb50">Admin User updated successfully</h4>
                    <div class="modal-footer">
                ...
                <div id="sucess-model-status-update" class="text-center hidden ">
                    <h4 class="mtb50">Admin User status updated successfully</h4>
                    <div class="modal-footer">
         ...
         <div class="modal-dialog modal-lg pos-rel js-loading-bar">
            <div class="loading-sec hidden"></div>
             <div class="modal-content">
                 ...
                 <div class="modal-header">
                     <button type="button" class="close js-btn-verify" data-dismiss="modal"><span aria-hidden="true">
                 ...
                 <form  id="admin-user-add-form" class="form-validation-notify form-horizontal form-label-left">
                    <div class="modal-body">
                        <div class="clearfix">
                            ...
                            <div class="form-group">
                                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="notes">User notes <span class="required">*</span>
                                 </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input data-api-attr="notes" type="text" id="notes" maxlength="80" value="" placeholder="user contact" data-parsley-required="true" class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>
                ...
                <div id="sucess-model" class="text-center hidden ">
                    <h4 class="mtb50">Admin User added successfully</h4>
                    <div class="modal-footer">
    ...
    <script type="text/template" id="managers_list_template">     
        <$$ _.each(characters, function(managerItems,index){ $$>
               ...
               <tr class="pointer">
                ...
                <td><$$= managerItems.notes $$></td>

                <td class="btn-sec text-center"><button type="button" class="btn btn-primary btn-xs js-edit-document" data-toggle="modal" data-target=".document-edit"> <i class="fa fa-edit"></i> Edit</button> <input type="text" value="<$$= managerItems.userId $$>" class="thisDocId hidden" /></td>
    ...
    <script type="text/javascript" id = "modal-popup-render-add">
        ...
        $(document).ready(function () {
           ...
           $('#admin-user-add-form').submit(function (e){
               ...
               var userAdminAttrs = ['loginName','password', 'name', 'notes'];
               var dataString = {};
	...
	alert("API_ENDPOINT:"+API_ENDPOINT);
          ...
          // Form post code here end 
            ...
            // Edit Admin User form post code here 
                ...
                var getCompanyDocuCallback = function(data){
                    ...
                    $('#admin-user-edit-form input[data-api-attr=notes]').val(data.notes);
                    ...
                    if(data.status == 20){
                        $('#admin-user-edit-form input[name=status-menu2]').prop('checked',true);
                        $('#admin-user-edit-form input[name=status-menu2]').prop('checked',false);
                    ...
                    $('#admin-user-edit-form').closest('.modal-content').find('#sucess-model-status-update').addClass('hidden');
        ...
        // ==================== GET_API_WRONG_RESPONSE code ====================
         $(document).ajaxError(function(event, jqxhr, settings, thrownError) {
            var userDuplicateError = settings.url.endsWith(comInstId +'/managers');
             if(jqxhr.status == 500 && userDuplicateError == true){
        ...
        var statusUpdateCallback = function(data){
                ...
                $('#admin-user-edit-form').addClass('hidden');
                var success_msg = data.status == 30 ? "Admin user record deactivated successfully" :  "Admin user record activated successfully";
                $('#admin-user-edit-form').closest('.modal-content').find('#sucess-model-status-update .mtb50').html(success_msg);
                $('#admin-user-edit-form').closest('.modal-content').find('#sucess-model-status-update').removeClass('hidden');
