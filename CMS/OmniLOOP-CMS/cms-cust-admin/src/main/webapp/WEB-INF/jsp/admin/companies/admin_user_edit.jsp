                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x_panel pos-rel">
                                ...
                                <div class="x_content">
                                    <div class="row">
                 <form  id="admin-user-form"  class="form-horizontal form-validation-notify form-label-left">
                        <div class="clearfix">
                            <div class="form-group">
                                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="login-name">Login ID <span class="required">*</span>
                                 </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input data-api-attr="loginName" type="text" id="login-name" maxlength="80" value="" required="required" disabled class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>
                            <div class="form-group">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input type="text" data-api-attr="name" id="user-name" maxlength="80" value="" data-parsley-required="true" class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>
                            <div class="form-group">
                                 <label for="password" class="control-label col-md-3">New Password <span class="required">*</span></label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input id="password" data-api-attr="password" type="password" value="" name="password" data-parsley-required="true" data-validate-length="6,8" class="form-control col-md-7 col-xs-12" required="required">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">Confirm new password <span class="required">*</span></label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input id="password2" data-api-attr="confPassword" type="password" value="" name="password2" data-parsley-required="true" data-validate-linked="password" class="form-control col-md-7 col-xs-12" required="required">
                                 </div>
                             </div>
                        </div>
            ...
            $('#admin-user-form').submit(function (e){
                ...
                if(formValidate == true){
                    ...
                    if(confPwd == true){
                        ...
                        var dataString = {name:feedName, password:feedPwd};
                        $('.x_panel .loading-sec').removeClass('hidden');
