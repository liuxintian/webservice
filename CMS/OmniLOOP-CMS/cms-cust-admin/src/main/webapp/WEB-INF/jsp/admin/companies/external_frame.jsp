...
<%
	String url = null;	
	String urlId = request.getParameter("exturl");
	if(urlId!=null){
		long id = Long.parseLong(urlId);
		url = user.getURLById(id);
	}
%>
...
<body class="nav-md">
        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="landing_content">
                    ...
                    <div class="row">
						<div id="company_info">
							<iframe id="iframe_external" style="width:100%;height:100%;min-height:1000px;overflow-y:auto;" scrolling="no" frameBorder="0" seamless="seamless" src="<%= url %>"></iframe>
						</div>
                    </div>
                </div>
    ...
    <script src="<%= baseURL %>/assets/js/seamless/iframeResizer.min.js"></script>
</body>
</html>
