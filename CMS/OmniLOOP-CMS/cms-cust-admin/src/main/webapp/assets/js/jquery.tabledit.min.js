    ...
    $.fn.Tabledit = function(options) {
        ...
        var Edit = {
            ...
            submit: function(td) {
                ...
                var ajaxResult = settings.disableAjax ? true : ajax(settings.buttons.edit.action);
                if (ajaxResult === false) {
                    return;
                }
        ...
        var Delete = {
            ...
            submit: function(td) {
                ...
                var ajaxResult = settings.disableAjax ? true : ajax(settings.buttons.delete.action);
                ...
                $(td).parent('tr').addClass(settings.mutedClass).find('.tabledit-toolbar button:not(.tabledit-restore-button)').closest('tr').remove();
                // Show restore button.
