...
@RestController
@RequestMapping("/company-instances/{cpId}/document-links")
public class DocumentLinksMediaController extends BaseController {
	...
	public List<DocumentLinksMediaBO> readAll(@PathVariable Long cpId, @ModelAttribute("serviceRequest") ServiceRequest sreq) {
