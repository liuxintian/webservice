            ...
            <div id="register" class="animate form">
                <section class="login_content">
                    <form  id="forget-pwd" class="form-validation-notify">
                        ...
                        <div id="resend-pwd">
                            <input name="email" data-api-attr="loginName"  type="email" class="form-control pwd-email" placeholder="john.doe@hotmail.com" data-parsley-required="true" data-parsley-type="email" />
