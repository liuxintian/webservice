...
<body class="nav-md">
                            ...
                            <div class="x_content">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <button type="button" class="btn btn-default refresh-menu-list"> <i class="fa fa-refresh"></i> Refresh List</button>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="row" id="remove-search-tools">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <thead>
                                            <tr class="headings">
                                                <th class="column-title">Menu Name </th>
                                                <th class="column-title">Menu Description </th>
                                                <th class="column-title">Valid Until </th>
                                                <th class="column-title">Status </th>
                                                <th class="column-title no-link last"><span class="nobr">Action</span></th>
                                                <th class="bulk-actions" colspan="7">
                        ...
                        <div class="clearfix">
                            <div class="form-group">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input data-api-attr="menuItemName" type="text" id="menu-name" maxlength="100" value="" placeholder="ex. title name" data-parsley-required="true" class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                 <label  class="control-label col-md-3 col-sm-3 col-xs-12" for="menu-desc">
                                     Menu Description (400 chars max)
                                 </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                 <textarea data-api-attr="menuItemDesc" id="menu-desc"  class="form-control" name="message" data-parsley-trigger="keyup"  data-parsley-maxlength="400" data-parsley-minlength-message="Dscription should be within 400 characters"></textarea>
                                 </div>
                             </div>
             ...
             <div class="modal-content">
                 ...
                 <form id="edit-menu-list" class="form-validation-notify form-horizontal form-label-left">
                    ...
                    <div class="modal-body">
                        <div class="clearfix">
                            <div class="form-group">
                                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="menu-name2">Menu Name <span class="required">*</span>
                                 </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input data-api-attr="menuItemName" type="text" id="menu-name2" maxlength="100" value="" placeholder="ex. title name" data-parsley-required="true" class="form-control col-md-7 col-xs-12">
                                 </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                 <textarea data-api-attr="menuItemDesc" id="menu-desc2"  class="form-control" name="message" data-parsley-trigger="keyup"  data-parsley-maxlength="400" data-parsley-minlength-message="Dscription should be within 400 characters"></textarea>
                                 </div>
                             </div>
    ...
    <script id = "main-list-render">
        ...
        var chainedStepTwo = function(inputResponse){
            ...
            return getMenuItems('ir-menu-items',compId);
        };
        ...
        var injectTpl = function (id,data) {
          ...
          var populateIRMenu = function(){
            ...
            getIrMenuItems('ir-menu-items').then(function (adata) {
                $('.x_panel').find('.loading-sec').removeClass('hidden');
                // body...
    ...
    <script type="text/javascript" id = "modal-popup-render-add">
        ...
        $(document).ready(function () {  
           ...
           $('#add-menu-list').submit(function (e){
               ...
               var menuAttrs = ['menuItemName','notes','menuItemDesc','validUntil'];
               var dataString = {};
               ...
               console.log(dataString);
                if(formValidate == true){
                   ...
                   $.postJSON(API_ENDPOINT+'ir-menu-items', dataString, postIRMenuCallback);
                }else{
           ...
           /* Form post code here end */
            ...
            $(".refresh-menu-list").click(function(){
                if(!_.isEmpty(menuTable)){
            ...
            $(document).on('click', '.js-edit-row' ,function(){
                ...
                $.getJSON(API_ENDPOINT+'ir-menu-items/'+irMenuId, dataString, getIrMenuItemsCallback);
            });
            var getIrMenuItemsCallback = function(data){
                ...
                $('#edit-menu-list input[data-api-attr=menuItemName]').val(data.menuItemName);
                $('#edit-menu-list textarea[data-api-attr=menuItemDesc]').val(data.menuItemDesc);
             ...
             //   $('#edit-menu-list textarea[data-api-attr=validUntil]').val(data.validUntil);
              //  $('#edit-menu-list textarea[data-api-attr=tagRole]').val(data.tagRole);
                ...
                if(_.contains([20, 30], data.status)){
                    addStatusUpdateBtn($('.js-confirmation-status'),API_ENDPOINT+'ir-menu-items/'+data.id,statusUpdatePayload,statusUpdateCallback);    
                }else if(!data.status){
            ...
            $(document).on('click', '.js-remove-row' ,function(){
             ...
             $('#edit-menu-list').submit(function (e){
               ...
               //var menuAttrs = ['menuItemName','validUntil','status','notes','menuItemDesc'];
               var menuAttrs = ['menuItemName','status','notes','menuItemDesc','validUntil'];
               var dataString = {};
               ...
               console.log(dataString);
                if(formValidate2 == true){
                    ...
                    console.log('success');
                    $('#edit-menu-list').closest('.js-loading-bar').find('.loading-sec').removeClass('hidden');
                   $.putJSON(API_ENDPOINT+'ir-menu-items/'+irMenuIdPut, dataString, putIRMenuCallback);
                }else{
                   // alert(UI_MESSAGES.form_validation_error);
                   toastNotifications(UI_MESSAGES.form_validation_error);
                }
